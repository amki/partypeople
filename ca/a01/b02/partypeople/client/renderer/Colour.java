...
public class Colour {
    ...
    public int getInt() {
        int val = 0;
        val = val | ((int) (this.a * 255) << 24);
        val = val | ((int) (this.r * 255) << 16);
        val = val | ((int) (this.g * 255) << 8);
        val = val | ((int) (this.b * 255));
    ...
    public Colour interpolate(Colour target, double d) {
        ...
        return new Colour(this.r * complement + target.r * d, this.g * complement + target.g * d, this.b * complement
                + target.b * d, this.a * complement + target.a * d);
    }
