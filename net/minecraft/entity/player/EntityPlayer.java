...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender {
    ...
    public EntityPlayer(World par1World) {
        ...
        this.setLocationAndAngles(var2.posX + 0.5D, (var2.posY + 1), var2.posZ + 0.5D, 0.0F, 0.0F);
    ...
    protected void updateItemUse(ItemStack par1ItemStack, int par2) {
        ...
        if (par1ItemStack.getItemUseAction() == EnumAction.eat) {
            for (int var3 = 0; var3 < par2; ++var3) {
                Vec3 var4 = this.worldObj.getWorldVec3Pool().getVecFromPool((this.rand.nextFloat() - 0.5D) * 0.1D,
                        Math.random() * 0.1D + 0.1D, 0.0D);
                var4.rotateAroundX(-this.rotationPitch * (float) Math.PI / 180.0F);
                var4.rotateAroundY(-this.rotationYaw * (float) Math.PI / 180.0F);
                Vec3 var5 = this.worldObj.getWorldVec3Pool().getVecFromPool((this.rand.nextFloat() - 0.5D) * 0.3D,
    ...
    public void updateRidden() {
        ...
        if (this.ridingEntity instanceof EntityLiving
                && ((EntityLiving) this.ridingEntity).shouldRiderFaceForward(this)) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isSprinting()) {
            this.landMovementFactor = (float) (this.landMovementFactor + this.capabilities.getWalkSpeed() * 0.3D);
    ...
    public void onDeath(DamageSource par1DamageSource) {
        ...
        if (!this.worldObj.isRemote) {
            PlayerDropsEvent event = new PlayerDropsEvent(this, par1DamageSource, this.capturedDrops,
                    this.recentlyHit > 0);
    ...
    public EntityItem dropOneItem(boolean par1) {
        ...
        if (stack.getItem().onDroppedByPlayer(stack, this)) {
            ...
            return ForgeHooks.onPlayerTossEvent(this, this.inventory.decrStackSize(this.inventory.currentItem, count));
        }
    ...
    public EntityItem dropPlayerItemWithRandomChoice(ItemStack par1ItemStack, boolean par2) {
        if (par1ItemStack == null) {
            ...
            EntityItem var3 = new EntityItem(this.worldObj, this.posX, this.posY - 0.30000001192092896D
                    + this.getEyeHeight(), this.posZ, par1ItemStack);
    ...
    public boolean canHarvestBlock(Block par1Block) {
        return ForgeEventFactory.doPlayerHarvestCheck(this, par1Block, this.inventory.canHarvestBlock(par1Block));
    }
        ...
        if (!(par1EntityLiving instanceof EntityCreeper) && !(par1EntityLiving instanceof EntityGhast)) {
            ...
            if (!(par1EntityLiving instanceof EntityPlayer) || this.isPVPEnabled()) {
                List var6 = this.worldObj.getEntitiesWithinAABB(
                        ...
                        AxisAlignedBB
                                .getAABBPool()
                                .addOrModifyAABBInPool(this.posX, this.posY, this.posZ, this.posX + 1.0D,
    ...
    protected void damageEntity(DamageSource par1DamageSource, int par2) {
        if (!this.isEntityInvulnerable()) {
            ...
            par2 = ArmorProperties.ApplyArmor(this, this.inventory.armorInventory, par1DamageSource, par2);
            if (par2 <= 0) {
                return;
            }
    ...
    public void attackTargetEntityWithCurrentItem(Entity par1Entity) {
        ...
        if (par1Entity.canAttackWithItem()) {
            if (!par1Entity.func_85031_j(this)) {
                ...
                if (var2 > 0 || var4 > 0) {
                    boolean var5 = this.fallDistance > 0.0F && !this.onGround && !this.isOnLadder()
                    ...
                    if (var8) {
                        if (var3 > 0) {
                            par1Entity.addVelocity(
                                    (-MathHelper.sin(this.rotationYaw * (float) Math.PI / 180.0F) * var3 * 0.5F), 0.1D,
    ...
    public EnumStatus sleepInBedAt(int par1, int par2, int par3) {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (Math.abs(this.posX - par1) > 3.0D || Math.abs(this.posY - par2) > 2.0D
                    || Math.abs(this.posZ - par3) > 3.0D) {
            ...
            List var8 = this.worldObj.getEntitiesWithinAABB(
                    EntityMob.class,
                    AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(par1 - var4, par2 - var6, par3 - var4,
                            par1 + var4, par2 + var6, par3 + var4));
        ...
        if (this.worldObj.blockExists(par1, par2, par3)) {
            ...
            if (block != null) {
                var5 = block.getBedDirection(this.worldObj, par1, par2, par3);
            }
            float var10 = 0.5F;
            float var7 = 0.5F;
            ...
            this.setPosition((par1 + var10), (par2 + 0.9375F), (par3 + var7));
        } else {
    ...
    public void wakeUpPlayer(boolean par1, boolean par2, boolean par3) {
        ...
        Block block = (var4 == null ? null
                : Block.blocksList[this.worldObj.getBlockId(var4.posX, var4.posY, var4.posZ)]);

        if (var4 != null && block != null && block.isBed(this.worldObj, var4.posX, var4.posY, var4.posZ, this)) {
            block.setBedOccupied(this.worldObj, var4.posX, var4.posY, var4.posZ, this, false);
            var5 = block.getBedSpawnPosition(this.worldObj, var4.posX, var4.posY, var4.posZ, this);
    ...
    private boolean isInBed() {
        ...
        int blockID = this.worldObj.getBlockId(c.posX, c.posY, c.posZ);
        return Block.blocksList[blockID] != null
                && Block.blocksList[blockID].isBed(this.worldObj, c.posX, c.posY, c.posZ, this);
    }
    ...
    public float getBedOrientationInDegrees() {
        if (this.playerLocation != null) {
            ...
            int var2 = (block == null ? 0 : block.getBedDirection(this.worldObj, x, y, z));
                ...
                if (this.ridingEntity instanceof EntityMinecart) {
                    ...
                    if (this.startMinecartRidingCoordinate == null) {
                        this.startMinecartRidingCoordinate = new ChunkCoordinates(MathHelper.floor_double(this.posX),
                                MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ));
                    } else if (this.startMinecartRidingCoordinate.getDistanceSquared(
    ...
    protected void fall(float par1) {
        if (!this.capabilities.allowFlying) {
            if (par1 >= 2.0F) {
                this.addStat(StatList.distanceFallenStat, (int) Math.round(par1 * 100.0D));
            }
    ...
    public int getItemIcon(ItemStack par1ItemStack, int par2) {
        ...
        if (par1ItemStack.itemID == Item.fishingRod.itemID && this.fishEntity != null) {
            ...
            var3 = par1ItemStack.getItem().getIconIndex(par1ItemStack, par2, this, this.itemInUse, this.itemInUseCount);
        }
    ...
    public void clonePlayer(EntityPlayer par1EntityPlayer, boolean par2) {
        ...
        if (old.hasKey(PERSISTED_NBT_TAG)) {
            this.getEntityData().setCompoundTag(PERSISTED_NBT_TAG, old.getCompoundTag(PERSISTED_NBT_TAG));
        }
    }
